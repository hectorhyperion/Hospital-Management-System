...
var detail = new Rickshaw.Graph.HoverDetail({
	graph: graph
	      ...
	      <!-- map -->
<link href="{{url('assets/css/jqvmap.css')}}" rel='stylesheet' type='text/css' />
<script src="{{url('assets/js/jquery.vmap.js')}}"></script>
<script src="{{url('assets/js/jquery.vmap.sampledata.js')}}" type="text/javascript"></script>
<script src="{{url('assets/js/jquery.vmap.world.js')}}" type="text/javascript"></script>
